...
class DailyStarterPage extends StatefulWidget {
  const DailyStarterPage({Key? key}) : super(key: key);

  @override
  _DailyStarterPageState createState() => _DailyStarterPageState();
}

class _DailyStarterPageState extends State<DailyStarterPage> {
